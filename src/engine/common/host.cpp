...
int EXPORT Host_Main( int argc, const char **argv, const char *progname, int bChangeGame, pfnChangeGame func )
{
	...
	host_cheats = Cvar_Get( "sv_cheats", "0", CVAR_ARCHIVE, "allow usage of cheat commands and variables" );
	host_maxfps = Cvar_Get( "fps_max", "0", CVAR_ARCHIVE, "host fps upper limit" );
